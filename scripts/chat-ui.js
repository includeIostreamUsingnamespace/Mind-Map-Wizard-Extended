class ChatManager {
    ...
    addSystemMessage(text, isError = false) {
        ...
        // 静态 SVG 属可信内容，动态文本必须用文本节点渲染，防止 HTML 注入
        span.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="34.0431 91.0588 732.1 617.8" height="60px" width="60px" style="margin-top:20vh;">
