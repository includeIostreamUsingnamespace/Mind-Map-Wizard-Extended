...
// 当前导图标题：用 var 声明以创建 window 属性，供 chat-ui.js / interaction.js 读取
var currentMindmapTitle = '';
...
(function () {
	...
	function __mmwInitEngine() {
		...
		__mmwEnginePromise = __mmwLoadScript('/scripts/mm-rendering/renderer.js?v=20260810')
			.then(() => __mmwLoadScript('/scripts/mm-rendering/interaction.js?v=20260810'))
			.then(() => {
				try {
