...
// XMind compatibility: expose HistoryManager
window.HistoryManager = HistoryManager;


// =====================================================
// XMind AI Functions - Right-click menu integration
// =====================================================

window.aiBrainstormNode = async function() {
    const nodeEl = window.currentNodeElement;
    if (!nodeEl) return;
    const nodeId = nodeEl.getAttribute('data-node-id');
...
window.aiResearchNode = async function() {
    const nodeEl = window.currentNodeElement;
    if (!nodeEl) return;
    const nodeId = nodeEl.getAttribute('data-node-id');
    if (!nodeId || !window.XMindAI) { alert('AI 模块未加载');; return; }
...
window.aiExplainNode = async function() {
    const nodeEl = window.currentNodeElement;
    if (!nodeEl) return;
    const nodeId = nodeEl.getAttribute('data-node-id');
    if (!nodeId || !window.XMindAI) { alert('AI 模块未加载');; return; }
...
window.aiPolishNode = async function() {
    const nodeEl = window.currentNodeElement;
    if (!nodeEl) return;
    const nodeId = nodeEl.getAttribute('data-node-id');
    if (!nodeId || !window.XMindAI) { alert('AI 模块未加载'); return; }
...
window.aiRestructureNode = async function() {
    const nodeEl = window.currentNodeElement;
    if (!nodeEl) return;
    const nodeId = nodeEl.getAttribute('data-node-id');
    if (!nodeId || !window.XMindAI) { alert('AI 模块未加载');; return; }
